...
//
// Une habitude se fait le soir (yoga 19h30, ménage 19h…) ; personne ne rouvre
// l'app juste après pour la cocher. Sans ce bloc, les habitudes ne sont jamais
// validées et « Vigilance vie » reste vide — c'est exactement ce qui se passait.
//
  ...
  return (
    <section className="card dash-section yesterday" aria-label="Hier">
      <div className="row brief-head">
        <h2>Hier</h2>
        <span className="faint">tu l'as fait ?</span>
      </div>
      {missed.map((h) => (
