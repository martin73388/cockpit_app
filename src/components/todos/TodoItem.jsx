...
import { isOverdue, dueLabel } from '../../utils/dates.js'
...
export function TodoItem({ todo, projectsById, layout, sortable, drag, onOpenModal }) {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="check"
        checked={todo.done}
        onChange={() => store.toggleTodoDone(todo.id)}
